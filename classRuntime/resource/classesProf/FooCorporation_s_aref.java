...
public class FooCorporation_s_aref {
	...
	public FooCorporation_s_aref(){
		...
		*/
		salarioTotal+= joao.pagamentoSemanal()+melissa.pagamentoSemanal()+
		               edson.pagamentoSemanal()+felipe.pagamentoSemanal()+
		               adam.pagamentoSemanal()+sofia.pagamentoSemanal();
	}
	...
	public static void main(String[] args){
		FooCorporation_s_aref empresa = new FooCorporation_s_aref();
